        ...
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav font-weight-bold mx-auto py-0">
                    ...
                    <a href="/groups" class="nav-item nav-link @yield('groups')">@lang('navbar.groups')</a>
                    <a href="/teachers" class="nav-item nav-link">@lang('navbar.teachers')</a>
                    <a href="/wins" class="nav-item nav-link ">@lang('navbar.wins')</a>
                    <a href="/gallery" class="nav-item nav-link">Galereya</a>
                    <a href="/blogs" class="nav-item nav-link">Maqolalar</a>
        ...
        <div class="row pt-5">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="d-flex flex-column justify-content-start">
                    ...
                    <a class="text-white mb-2" href="/groups"><i class="fa fa-angle-right mr-2"></i>Sinflar</a>
                    <a class="text-white mb-2" href="/teachers"><i class="fa fa-angle-right mr-2"></i>O'qituvchilar</a>
                    <a class="text-white mb-2" href="/gallery"><i class="fa fa-angle-right mr-2"></i>Galereya</a>
                    <a class="text-white mb-2" href="/blogs"><i class="fa fa-angle-right mr-2"></i>Maqolalar</a>
